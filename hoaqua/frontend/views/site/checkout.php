                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <form class="needs-validation" novalidate>
                            ...
                            <div class=" mb-3">
                                <label for="country">Thành phố(tỉnh) *</label>
                                <select class="wide w-100" id="country">
                                <option value="Choose..." data-display="Select">Mời chọn...</option>
                                <?php $h = Countries::find()->all();
                                
                                foreach ($h as $key2 => $value) {
                                    if ($value) {
                                ?>
                                    <option value="United States"><?php echo $value["country"] ?></option>
                                <?php }} ?>
                            </select>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="row">
                            ...
                            <div class="odr-box">
                                ...
                                <div class="rounded p-2 bg-light">
                                    ...
                                    <div class="media mb-2 border-bottom">
                                        <div class="media-body"> <a href="detail.html"><?php echo $value["product_title"] ?></a>
                                            <div class="text-muted">Giá: <?php echo number_format($value["product_price"])?> VND</div>
                                            <span class="mx-2">|</span>Số lượng: <?php echo $value["amount"] ?>
                                            <span class="mx-2">|</span>tổng: <?php echo number_format($value["amount"] * $value["product_price"])?></div>
                                        </div>
                                    </div>
                                    <?php }?>
                                    <!-- <div class="media mb-2 border-bottom">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="order-box">
                                <div class="title-left">
                                    <h3>Mặt hàng của bạn</h3>
                                </div>
                                <div class="d-flex">
                                    <div class="font-weight-bold">Sản phẩm</div>
                                    <div class="ml-auto font-weight-bold">Tổng tiền</div>
                                </div>
                                <!-- <hr class="my-1">
                                <div class="d-flex">
                                    <h4>Sub Total</h4>
