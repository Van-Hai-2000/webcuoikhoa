...
use backend\models\productdetailSE;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ProductsdtController implements the CRUD actions for productdetail model.
 */
class ProductsdtController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new productdetailSE();
