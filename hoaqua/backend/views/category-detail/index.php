...
/* @var $searchModel backend\models\CategoryDetailSE */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Danh mục cấp';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="category-detail-index">
   ...
   <div class="panel panel-primary">
         ...
         <p class="pull right">
        <?= Html::a('Thêm danh mục cấp', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
         <?= GridView::widget([
            ...
            [
                ...
                'delete'=>function($url,$model){
                    return Html::a('Delete', $url, [
                        ...
                        'data-confirm'=>'Bạn có chắc muốn xóa: '. $model->cat_title,
                        'data-method'=>'post'
            ]);
                },
            ],
